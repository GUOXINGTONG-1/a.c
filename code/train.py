import torch
from nl2sql import SQLBert, BertAdam, BertTokenizer
from nl2sql import *
import time
...
if __name__ == '__main__':
	...
	# load dataset
	train_sql, train_table, train_db, dev_sql, dev_table, dev_db = loading_dataset(data_dir=data_dir, use_small=use_small)
